...
def kernel_tq4_unified_attention_2d(
    ...
    for j in range(tile_start, tile_end):
        ...
        # Scale normals and merge with outliers
        K_normal = K_normal * inv_sqrt_d * k_norm[None, :]
        K = tl.where(is_out[:, None], K_outlier, K_normal).to(Q.dtype)
